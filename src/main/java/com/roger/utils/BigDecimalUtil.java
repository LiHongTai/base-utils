...
public class BigDecimalUtil {
     ...
     * 大于等于
     */
    public static boolean greaterThanOrEqualsTo(BigDecimal b1, BigDecimal b2) {
        if (b1 == null || b2 == null) {
            return false;
        }
        return 0 < b1.compareTo(b2) || 0 == b1.compareTo(b2);
    }
     ...
     * 小于等于
     */
    public static boolean lessThanOrEqualsTo(BigDecimal b1, BigDecimal b2) {
        if (b1 == null || b2 == null) {
            return false;
        }
        return 0 > b1.compareTo(b2) || 0 == b1.compareTo(b2);
